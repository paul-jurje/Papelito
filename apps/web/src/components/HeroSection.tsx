  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6 pt-20 pb-16 text-center sm:pt-28 lg:pt-32">
        ...
        >
          Write more.
          <span className="block mt-1 bg-gradient-to-r from-indigo-600 via-indigo-900 to-indigo-600 bg-clip-text text-transparent">Worry less.</span>
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-base text-slate-600 sm:text-lg">
          Papelito is a distraction-free writing app that saves your work as you type.
          No clutter, no setup — just a beautiful, quiet place for your words.
        </p>
          ...
          <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-6 sm:p-10 text-left">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
              <div className="flex items-center gap-1.5">
                ...
                <span className="h-3 w-3 rounded-full bg-slate-200" />
                <span className="h-3 w-3 rounded-full bg-slate-200" />
                <span className="ml-3 text-xs font-medium text-slate-400 select-none">The Great Novel.txt</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-[11px] font-semibold text-emerald-700 tracking-wide uppercase">Autosaved</span>
              </div>
            </div>
            <div className="writing-font space-y-4 text-slate-800">
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 border-none outline-none">Chapter One: The Quiet Shore</h2>
              <p className="text-sm leading-relaxed sm:text-base">
                The sea was flat and calm, reflecting the pale silver of the morning sky. In the small cabin atop the dunes, nothing could be heard but the soft click of the keys and the rhythmic wash of the tides below. For the first time in months, the words flowed without hesitation...
              </p>
